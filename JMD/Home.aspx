        ...
        <ul class="right-form">
             <asp:Label ID="Label2" runat="server" Text="Login:"></asp:Label>
				<div>
                  ...
                  <li>  <asp:TextBox  ID="TextBox5" runat="server" placeholder="UserName"></asp:TextBox></li>
                    <li><asp:TextBox  ID="TextBox6" runat="server" placeholder="Password"></asp:TextBox></li>
