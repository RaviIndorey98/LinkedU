...
<body>
    ...
    <div class="main">
        ...
        <form id="form1" runat="server">
            <ul id="Ul1" class="left-form" runat="server">
        ...
        <ul class="right-form">
            ...
            <asp:Button ID="Button1" runat="server" Text="Login" Height="39px" Width="131px" Style="margin-left: 63px" OnClick="Button1_Click1" />
        </ul>
    <div class="clear"></div>
    </form>
     </div>
